...
var saveOptions = function() {
  ...
  sendMessage({
    message: "save_options",
    bwt: buttonWaitTimeout
  });
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function processDataFromExist(name) {
    chrome.storage.local.get(name, function(dataSet) {
      if ((dataSet[name] !== null) && (dataSet[name] !== undefined) && (dataSet[name] !== "")) {
        ...
        if ((data.message !== null) && (data.message !== undefined) && (data.find !== null) && (data.find !== undefined) && (data.code !== null) && (data.code !== undefined)) {
  ...
  chrome.storage.local.get(null, function(items) {
    ...
    if ((items.buttonWaitTimeout !== undefined) && (items.buttonWaitTimeout !== null) && (items.cycleCount !== undefined) && (items.cycleCount !== null)) {
