...
function(request, sender, sendResponse) {
  ...
  if (request.message.message === "save_options") {
    ...
    if ((request.message.bwt !== null) && (request.message.bwt !== undefined) && (request.message.bwt > 0)) {
...
chrome.storage.local.get(null, function(items) {
  ...
  if ((items.buttonWaitTimeout !== undefined) && (items.buttonWaitTimeout !== null) && (items.buttonWaitTimeout > 0)) {
